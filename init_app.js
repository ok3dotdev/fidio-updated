...
if (fs.existsSync(useFile)) {
  ...
  fs.copyFileSync(
    'customModules/middleware/defaults/Middleware_backup.js',
    useFile
  );
...
if (fs.existsSync(useFile)) {
  ...
  fs.copyFileSync(
    'customModules/middleware/defaults/MiddlewareFunctions_backup.js',
    useFile
  );
  //console.log(useFile, 'File does not exist on', process.platform)
}
...
if (fs.existsSync(useFile)) {
  ...
  const data =
    "import React from 'react'; const MyComponent = () => { return <div>Privacy</div> }; export default MyComponent";
...
if (fs.existsSync(useFile)) {
  ...
  const data =
    "import React from 'react'; const MyComponent = () => { return <div>Terms</div> }; export default MyComponent";
  fs.writeFile(useFile + '.js', data, (err) => {
    //console.log(err)
  });
  //console.log(useFile, 'File does not exist on', process.platform)
