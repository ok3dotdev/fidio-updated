...
var Module = function Module(props) {
  ...
  return <_react.default.Fragment>
            {props !== null && props !== void 0 && props.useMenu ? <div style={{
      width: 100 + "%",
      ...
      padding: props !== null && props !== void 0 && (_props$menuConfig2 = props.menuConfig) !== null && _props$menuConfig2 !== void 0 && _props$menuConfig2.padding ? props.menuConfig.padding : ''
        ...
        maxHeight: '100%'
                            ...
                            <_SubMenu.default {...Object.assign({}, props, {
          handleToggleMenuOff: handleToggleMenuOff
        })}></_SubMenu.default>
                            <ul className={!props._loggedIn ? "".concat(_MenuModule["default"].menu, " ").concat(_MenuModule["default"].menuClosed) : _MenuModule["default"].menu}>
            ...
            return <_react.default.Fragment key={i}>
                                                {c.type ? c.type === 'user' ? <_index3.DropMenu {...Object.assign({}, props, {
              ...
              })} /> : c.type === 'cart' ? <div className={"".concat(c.className, " ").concat(c.smallUntilHover ? "".concat(_MenuModule["default"].smallUntilHover) : null)}>
                                                                <_Tooltip.default title='Cart' placement='bottom'>
                                                                    <li className={"".concat(_MenuModule["default"].menuLink, " darkMenuLink menuLinkSelector")} onClick={handleToggleCart} style={{
                    alignSelf: 'center'
                  }}>
                                                                        <span className={"".concat(_MenuModule["default"].menuLinkText)}>
                                                                            <div className={"".concat(_MenuModule["default"].menuText)}>Cart</div>
                                                                            <div className={"".concat(_MenuModule["default"].menuLinkIconPair, " ").concat(_MenuModule["default"].maxIconWidth, " cart material-icons")}>shopping_cart</div>
                                                                        </span>
                                                                        <div className={"".concat(_MenuModule["default"].menuLinkIcon, " ").concat(_MenuModule["default"].maxIconWidth, " cart material-icons")}>shopping_cart</div>
                                                                    </li>
                                                                </_Tooltip.default>
                                                            </div> : c.type === 'stream' ? <_link.default href={c.href} className={"menuLinkSelector ".concat(c.className, " ").concat(c.smallUntilHover ? "".concat(_MenuModule["default"].smallUntilHover) : null)} style={{
                alignSelf: 'center'
              }}>
                                                                    <_Tooltip.default title='Livestream Now' placement='bottom'>
                                                                        <li className={"".concat(_MenuModule["default"].menuLink, " darkMenuLink menuLinkSelector ").concat(c.className)} style={{
                    alignSelf: 'center'
                  }} onClick={handleToggleMenuOff}>
                                                                            <span className={"".concat(_MenuModule["default"].menuLinkText)}>
                                                                                <div className={"".concat(_MenuModule["default"].menuText)}>Stream</div>
                                                                                <div className={"".concat(_MenuModule["default"].menuLinkIconPair, " ").concat(_MenuModule["default"].maxIconWidth, " live_tv material-icons")}>live_tv</div>
                                                                            </span>
                                                                            <div className={"".concat(_MenuModule["default"].menuLinkIcon, " ").concat(_MenuModule["default"].maxIconWidth, " live_tv material-icons")}>live_tv</div>
                                                                        </li>
                                                                    </_Tooltip.default>
                                                                </_link.default> : c.type === 'notifications' ? <div className={"menuLinkSelector ".concat(c.className, " ").concat(c.smallUntilHover ? "".concat(_MenuModule["default"].smallUntilHover) : null)} style={{
                alignSelf: 'center'
              }}>
                                                                <_Tooltip.default title='Notifications' placement='bottom'>
                                                                    <li className={"".concat(_MenuModule["default"].menuLink, " darkMenuLink menuLinkSelector ").concat(c.className)} style={{
                    alignSelf: 'center'
                  }} onClick={handleToggleNotifications}>
                                                                        <span className={"".concat(_MenuModule["default"].menuLinkText)}>
                                                                            <div className={"".concat(_MenuModule["default"].menuText)}>Notifications</div>
                                                                            <div className={"".concat(_MenuModule["default"].menuLinkIconPair, " ").concat(_MenuModule["default"].maxIconWidth, " live_tv material-icons")}>notifications</div>
                                                                        </span>
                                                                        <div className={"".concat(_MenuModule["default"].menuLinkIcon, " ").concat(_MenuModule["default"].maxIconWidth, " live_tv material-icons")}>notifications</div>
                                                                    </li>
                                                                </_Tooltip.default>
                                                            </div> : c.type === 'link' ? <_link.default href={c.href} className={"menuLinkSelector ".concat(c.className)} style={{
                alignSelf: 'center'
              }}>
                                                                <li className={"".concat(_MenuModule["default"].menuLink, " darkMenuLink menuLinkSelector ").concat(c.className)} style={{
                  alignSelf: 'center'
                                                                    ...
                                                                    <div className={"".concat(_MenuModule["default"].menuLinkIcon, " ").concat(_MenuModule["default"].maxIconWidth, " material-icons")}>{c.name}</div>
                                                                </li>
                        ...
                        <_index.Help {...Object.assign({}, props, {
        open: helpOpen,
        setHelpOpen: setHelpOpen
      })}></_index.Help>
                        <_cart2.CartInternal {...Object.assign({}, props, {
        ...
        forceShowCc: props === null || props === void 0 || (_props$paymentConfig = props.paymentConfig) === null || _props$paymentConfig === void 0 ? void 0 : _props$paymentConfig.forceShowCc
                        ...
                        <_notifications.Notifications {...Object.assign({}, props, {
        passOveride: passOveride,
        forceShowCc: props === null || props === void 0 || (_props$paymentConfig2 = props.paymentConfig) === null || _props$paymentConfig2 === void 0 ? void 0 : _props$paymentConfig2.forceShowCc
                        ...
                        <_index2.SurveyContainer {...Object.assign({}, props, {
        handleName: "feedback",
