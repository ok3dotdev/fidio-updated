...
var PageContainer = function PageContainer(props) {
  ...
  var resolvedPage = (0, _utility.resolvePage)((0, _app["default"])(props._configVariables, props), props.path);
  resolvedDefinition = resolvedPage && resolvedPage.data; // Access the `data` property

  var getDefaults = /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(force) {
      var defaults, newProps;
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _utility.resolveDefaults)(resolvedPage.url, props, props._configVariables, query, asPath, setFetching, force);
          case 2:
    ...
    return function getDefaults(_x) {
      return _ref.apply(this, arguments);
    };
  }();
  props._LocalEventEmitter.unsubscribe('refetchDefaults');
  props._LocalEventEmitter.subscribe('refetchDefaults', function (e) {
    getDefaults(true);
  });
  ...
  var useProps = (0, _utility.handlePropsPriority)(mergeProps, props);
