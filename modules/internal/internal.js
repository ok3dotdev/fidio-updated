...
var Internal = function Internal(usePageProps) {
  ...
  return <div>
            <_socket3.SocketContainer {...Object.assign({
      _socket: _socket,
      setRooms: _setRooms
    }, pageProps)}></_socket3.SocketContainer>
            <div className={"".concat(fetchBusy ? 'fetchNotBusy fetchBusy' : 'fetchNotBusy')}></div>
            <_middleware.UseMiddleware {...pageProps} />
			{(_pageProps11 = pageProps) !== null && _pageProps11 !== void 0 && _pageProps11.dev ? <_.DeveloperHelp {...pageProps} /> : null}
		</div>;
};
