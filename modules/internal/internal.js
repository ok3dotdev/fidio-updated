...
const Internal = usePageProps => {
  ...
  return /*#__PURE__*/_jsx("div", {}, void 0, <SocketContainer _socket={_socket} setRooms={_setRooms} {...pageProps}></SocketContainer>, /*#__PURE__*/_jsx("div", {
    className: `${fetchBusy ? 'fetchNotBusy fetchBusy' : 'fetchNotBusy'}`
  }), <UseMiddleware {...pageProps} />, pageProps?.dev ? <DeveloperHelp {...pageProps} /> : null);
};
