...
var GridList = function GridList(props) {
  ...
  return <div className={"".concat(_gridListModule["default"].leadContainer)}>
            {props._gridItems && props._gridItems.map ? props._gridListType == 'video' ? props._gridItems.map(function (item, i) {
      return <div className={"".concat(_gridListModule["default"].col)} key={i}>
                                <_videoItem.default {...Object.assign({
          item: item,
          index: i,
