...
const Module = props => {
  ...
  }, void 0, <Chat {...props} setMobileStyleConfigs={props?.handleSetMobileStyleConfigs} chatFor={props?.watchData?.id} videoStatus={props?.watchData?.status} chatState={props?.chatState} />);
};
