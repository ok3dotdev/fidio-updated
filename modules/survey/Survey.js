...
const Module = props => {
  ...
  const resolveStageItem = (useStageItem, useAnimatingBack, useStyles, useAnimatingNext, useKeepCurrent, useStage) => {
    return /*#__PURE__*/_jsx("div", {
    ...
    }, void 0, /*#__PURE__*/_jsx("h1", {
      className: `${styles.title} survey_title`
    }, void 0, useStageItem?.label), useStageItem?.input?.type === 'select' ? /*#__PURE__*/_jsx("ul", {
      className: styles.survey__optionsList
    }, void 0, useStageItem?.input?.options.map(option => /*#__PURE__*/_jsx("li", {}, option.label, /*#__PURE__*/_jsx("button", {
      ...
      value: option.label
    }, void 0, option.label)))) : useStageItem?.input?.type === 'number' ? /*#__PURE__*/_jsx("div", {}, void 0, <input type='number' className={`${styles.numberInput}`} defaultValue={useStageItem?.input?.default} ref={inputRef}></input>) : useStageItem?.input?.type === 'text' ? /*#__PURE__*/_jsx("div", {}, void 0, <TextareaAutosize type='text' className={`${styles.textInput}`} placeholder={useStageItem?.input?.default} minRows={3} ref={inputRef} onKeyDown={handleKeyDown} goto={useStageItem?.confirm?.goto} question={useStageItem?.label} defaultValue={answers[useStage]?.answer}></TextareaAutosize>) : useStageItem?.component && typeof useStageItem.component === 'function' ? /*#__PURE__*/_jsx("div", {}, void 0, resolveComponent(useStageItem)) : null, useStageItem?.pipeline?.map ? useStageItem.pipeline.map((m, i) => /*#__PURE__*/_jsx("div", {
      className: "survey_pipelineItemContainer",
      style: {
        marginBottom: '.25rem'
      }
    }, i, /*#__PURE__*/_jsx("label", {
      style: {
        lineHeight: '1.5rem'
      }
    }, void 0, m?.label ?? ''), /*#__PURE__*/_jsx("div", {}, void 0, m?.input?.type === 'text' ? /*#__PURE__*/_jsx("div", {
      className: `${m?.className}`
    }, void 0, /*#__PURE__*/_jsx(TextareaAutosize, {
      type: "text",
      ...
      surveyclear: "true"
    })) : m?.input?.type === 'datetime-local' ? /*#__PURE__*/_jsx("div", {
      className: `${m?.className}`
      ...
      surveyclear: "true",
      usedefault: pipelineObject[m?.input?.var]
    })) : m?.input?.type === 'lineup' ? /*#__PURE__*/_jsx("div", {
      className: `${m?.className}`
    }, void 0, <Lineup {...props} product={pipelineDbItem} editing={pipelineDbItem} editingOptionsMeta={pipelineDbItem?.detailmeta ?? null} setOptionsMetaData={setOptionsMetaData} currentLineupEditing={currentLineupEditing} setCurrentLineupEditing={setCurrentLineupEditing} appendFormData={appendFormData} />) : m?.input?.type === 'price' ? /*#__PURE__*/_jsx("div", {
      className: `${m?.className} flex gap-p2`
    }, void 0, _span || (_span = /*#__PURE__*/_jsx("span", {}, void 0, "$")), /*#__PURE__*/_jsx("span", {}, void 0, /*#__PURE__*/_jsx("input", {
      type: "text",
      style: {
        width: '100%'
      },
    ...
    }))) : m?.input?.type === 'quantity' ? /*#__PURE__*/_jsx("div", {
      className: `${m?.className} flex gap-p2`
    }, void 0, _span2 || (_span2 = /*#__PURE__*/_jsx("span", {}, void 0, "Qty")), /*#__PURE__*/_jsx("span", {}, void 0, /*#__PURE__*/_jsx("input", {
      type: "text",
      style: {
        width: '100%'
      },
    ...
    }))) : m?.input?.type === 'image' && ['leadImg', 'featureImg'].indexOf(m?.input?.var) > -1 ? /*#__PURE__*/_jsx("div", {
      className: `${m?.className}`
    ...
    }, void 0, resolveImg(m)), /*#__PURE__*/_jsx("div", {
    ...
    }, void 0, "add"), /*#__PURE__*/_jsx("div", {}, void 0, m?.note)), /*#__PURE__*/_jsx("input", {
      style: {
        display: 'none'
      },
      type: "file",
    ...
    })) : m?.component ? /*#__PURE__*/_jsx("div", {}, void 0, resolveComponent(m)) : null))) : null, /*#__PURE__*/_jsx("div", {
      className: "survey_errorContainer"
    }, void 0, <div className='error' ref={currentError} style={{
      opacity: 0
    }}>{errorLog[useStage]}</div>), /*#__PURE__*/_jsx("div", {
    ...
    }, void 0, useStageItem?.confirm?.label ? useStageItem?.confirm.label : useStageItem?.confirm?.goto === 'end' ? 'Confirm' : 'Next'), backList && backList.length > 0 && !useStageItem?.submit && !submitted ? /*#__PURE__*/_jsx("button", {
  ...
  }, void 0, back ? resolveStageItem(backStageItem, 'animatingBackBack', 'backItem', null, null, back) : null, resolveStageItem(currentStageItem, 'animatingBackCurrent', 'currentItem', 'animatingNextCurrent', true, currentStage), next ? resolveStageItem(nextStageItem, null, 'nextItem', 'animatingNextNext', null, next) : null);
};
