...
var Module = function Module(props) {
  ...
  var handleUpdateSearch = _react["default"].useCallback(function (e) {
    ...
    if (query !== null && currentIndex && props.helpIndex) {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
    className: "Ecommerce_Cart_Container ".concat(props.className, " ").concat(menuOpen && closing ? 'Ecommerce_Cart_Container_Visible' : '')
    ...
    return m !== null && m !== void 0 && m.a ? /*#__PURE__*/_react["default"].createElement("a", {
      ...
      className: "Ecommerce_Item_Container Ecommerce_Item_DarkContainerHover",
      style: {
        padding: '.5rem',
        display: 'grid',
        gap: '.25rem'
      ...
      className: "Ecommerce_Item_Container",
      style: {
        padding: '.5rem',
        display: 'grid',
        gap: '.25rem'
