...
var Module = function Module(props) {
  ...
  return <div className={"".concat(props.className, " Admin_Build_Container")}>
      ...
      marginTop: '.5rem'
          ...
          display: 'none'
            ...
            width: 'fit-content'
                            ...
                            <_Tooltip.default title='Upload your new build in .next.tar.gz format. Use makebuild script to create new build' placement='right'>
                                <div style={{
                marginBottom: '.125rem'
          ...
          display: 'none'
            ...
            width: 'fit-content'
                            ...
                            <_Tooltip.default title='Upload your new public folder in public.tar.gz format. Use makebuild script to create public folder tar' placement='right'>
                                <div style={{
                marginBottom: '.125rem'
            ...
            width: 'fit-content'
                            ...
                            <_Tooltip.default title='Daemons current build uploaded to client server directory' placement='right'>
                                <div style={{
                marginBottom: '.125rem'
            ...
            width: 'fit-content'
                            ...
                            <_Tooltip.default title='Currently installed Packages' placement='right'>
                                <div style={{
                marginBottom: '.125rem'
            ...
            overflow: 'auto'
              ...
              return <div className='flex gap-p5' key={i}>
                                            <div>{m[0]}</div>
                                            <div>{m[1]}</div>
                                        </div>;
            }) : null}
            ...
            width: 'fit-content'
                            ...
                            <_Tooltip.default title='Install NPM Package here. Use Package@Version syntax for specific Version if required. Request must be approved by repo if package not already whitelisted' placement='right'>
                                <div style={{
                marginBottom: '.125rem'
              }}>{_b5 || (_b5 = <b>Run Install</b>)}</div>
                            </_Tooltip.default>
                        </div>
                        <div className={"".concat(_AdminModule["default"].adminPair, " admin_pair")}>
            ...
            width: 'fit-content'
                            ...
                            <_Tooltip.default title='Will uninstall package referenced here. Ensure to upload new build before uninstalling packages that current build relies on. Otherwise platform will go down' placement='right'>
                                <div style={{
                marginBottom: '.125rem'
