...
var Module = function Module(props) {
          ...
          while (1)
            switch ((_context.prev = _context.next)) {
              ...
              case 19:
                ...
                console.log('heoooooo', stringified);
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1)
            switch ((_context2.prev = _context2.next)) {
              case 0:
                options =
                  _args2.length > 4 && _args2[4] !== undefined ? _args2[4] : {};
                if (!(user.identifier && user.hash && domainKey)) {
                  _context2.next = 31;
                  break;
                }
    ...
    try {
      ...
      if (e && e.target && e.target.files) {
        ...
        if (files && files.length > 0) {
          var filesRenamed = Array.from(files)
  ...
  var handleInstall = _react['default'].useCallback(function (e) {
    ...
    if (
      e !== null &&
      e !== void 0 &&
      (_e$target3 = e.target) !== null &&
      _e$target3 !== void 0 &&
      _e$target3.getAttribute('modif')
    ) {
      var modif = e.target.getAttribute('modif');
      if (modif) {
        ...
        if (
          modif === 'uninstall' &&
          uninstallPackageRef !== null &&
          uninstallPackageRef !== void 0 &&
          (_uninstallPackageRef$ = uninstallPackageRef.current) !== null &&
          _uninstallPackageRef$ !== void 0 &&
          _uninstallPackageRef$.value
        ) {
          installPackage(
            props.apiUrl,
            props.domainKey,
            props._loggedIn,
            uninstallPackageRef.current.value,
            {
              uninstall: true,
            }
          );
      ...
      installPackageRef !== null &&
      installPackageRef !== void 0 &&
      (_installPackageRef$cu = installPackageRef.current) !== null &&
      _installPackageRef$cu !== void 0 &&
      _installPackageRef$cu.value
    ) {
      installPackage(
        props.apiUrl,
        props.domainKey,
        props._loggedIn,
        installPackageRef.current.value
      );
    }
  });
          ...
          while (1)
            switch ((_context6.prev = _context6.next)) {
              ...
              case 24:
                ...
                setMsg7(
                  'Attempted to Daemon Build. Refresh on another tab to check'
                );
  ...
  var strippedUrl =
    props !== null && props !== void 0 && props.domainUrl
      ? props.domainUrl.replace(/(?:www\.)?/, '')
      : '';
  ...
  return /*#__PURE__*/ _react['default'].createElement(
    ...
    /*#__PURE__*/ _react['default'].createElement('h3', null, 'Build'),
      ...
      /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          /*#__PURE__*/ _react['default'].createElement(
            ...
            {
              title:
                'Upload your new build in .next.tar.gz format. Use makebuild script to create new build',
              placement: 'right',
            },
            /*#__PURE__*/ _react['default'].createElement(
              'div',
      ...
      /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          /*#__PURE__*/ _react['default'].createElement(
            ...
            {
              title:
                'Upload your new public folder in public.tar.gz format. Use makebuild script to create public folder tar',
              placement: 'right',
            },
            /*#__PURE__*/ _react['default'].createElement(
              'div',
      ...
      /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          /*#__PURE__*/ _react['default'].createElement(
            ...
            {
              title:
                'Daemons current build uploaded to client server directory',
              placement: 'right',
            },
            /*#__PURE__*/ _react['default'].createElement(
              'div',
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          'Caution: Running a bad build will bring down the platform immediately. Running new builds without having installed packages will cause the platform to be taken offline as well. This is temporary until platform at sys.',
          strippedUrl,
          ' can be run to serve builds when ',
          props.domainUrl,
          ' is offline.'
        ),
        /*#__PURE__*/ _react['default'].createElement(
      ...
      /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          packages && Object.entries(packages)
            ? Object.entries(packages).map(function (m, i) {
                return /*#__PURE__*/ _react['default'].createElement(
                  'div',
                  {
      ...
      /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          /*#__PURE__*/ _react['default'].createElement(
            ...
            {
              title:
                'Install NPM Package here. Use Package@Version syntax for specific Version if required. Request must be approved by repo if package not already whitelisted',
              placement: 'right',
            },
            /*#__PURE__*/ _react['default'].createElement(
              'div',
      ...
      /*#__PURE__*/ _react['default'].createElement(
        ...
        /*#__PURE__*/ _react['default'].createElement(
          ...
          /*#__PURE__*/ _react['default'].createElement(
            ...
            {
              title:
                'Will uninstall package referenced here. Ensure to upload new build before uninstalling packages that current build relies on. Otherwise platform will go down',
              placement: 'right',
            },
            /*#__PURE__*/ _react['default'].createElement(
              'div',
