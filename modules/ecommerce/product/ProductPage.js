...
var Module = function Module(props) {
  ...
  return <_react.default.Fragment>
            {_localImports.ReactCarouselCss}
            <div className={"".concat(_ProductImageManagerModule["default"].container, " ").concat(props.className)}>
                <div className={"".concat(_ProductImageManagerModule["default"].innerContainer)}>
                    <div className={"".concat(_ProductImageManagerModule["default"].leadProductContainer)}>
                        <div className={"".concat(_ProductImageManagerModule["default"].singleProductCarouselProvider)}>
                            <div className={"".concat(_ProductImageManagerModule["default"].productSliderThumbnailListContainer)}>
                                {product !== null && product !== void 0 && product.images ? product.images.map(function (image, i) {
                var _props$cdn2;
                return <div slide={i} key={i} className={"".concat(_ProductImageManagerModule["default"].productSliderThumbSelectMin)} onClick={handleSetSlide} i={i}>
                                            <_image.default className={"".concat(_ProductImageManagerModule["default"].sliderThumbSelectMinImg)} loader={function () {
                    var _props$cdn;
                  ...
                  }} src={props !== null && props !== void 0 && (_props$cdn2 = props.cdn) !== null && _props$cdn2 !== void 0 && _props$cdn2["static"] ? "".concat(props.cdn["static"], "/").concat(image.name) : null} alt='Title' width={35} height={45} layout="responsive" />
                                        </div>;
              }) : null}
                            </div>
              ...
              ref: sliderTrackRef
                                ...
                                {product !== null && product !== void 0 && product.images ? product.images.map(function (image, i) {
                return <div index={i} key={i}>
                                                <div className={"".concat(_ProductImageManagerModule["default"].productSliderProductImg)} style={{
                    backgroundImage: "url(".concat(props.cdn["static"], "/").concat(image.name, ")")
                        ...
                        <div>
                            <h1 className={"".concat(_ProductImageManagerModule["default"].productPageTitle)}>{(_product$name = product === null || product === void 0 ? void 0 : product.name) !== null && _product$name !== void 0 ? _product$name : null}</h1>
                            <div>
                                <div>{(_product$detailmeta$d = product === null || product === void 0 || (_product$detailmeta = product.detailmeta) === null || _product$detailmeta === void 0 ? void 0 : _product$detailmeta.description) !== null && _product$detailmeta$d !== void 0 ? _product$detailmeta$d : null}</div>
                            </div>
                            <div>
                ...
                marginTop: '.5rem'
                                    ...
                                    <button onClick={handleFireGlobalEvent} item={product === null || product === void 0 ? void 0 : product.id} selectedstyle={selectedStyle} currentoption={currentOption} action='add_to_cart'>Add To Cart</button>
                                    {product !== null && product !== void 0 && (_product$detailmeta2 = product.detailmeta) !== null && _product$detailmeta2 !== void 0 && _product$detailmeta2.subscription ? <button onClick={handleFireGlobalEvent} item={product === null || product === void 0 ? void 0 : product.id} selectedstyle={selectedStyle} currentoption={currentOption} action='add_to_cart_subscribe'>Subscribe</button> : null}
                                </div>
                            </div>
                        </div>
                    </div>
