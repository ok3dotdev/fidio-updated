...
var Module = function Module(props) {
  ...
  return <div>
            {m ? function (_m$paymentmethoddetai, _m$paymentmethoddetai2, _m$paymentmethoddetai3, _m$paymentmethoddetai4, _m$id, _m$id2, _m$cart, _westernMoneyFormat$f, _m$totals, _m$meta, _card$brand, _card$last) {
      var useSymbol;
        ...
        paddingBottom: '1rem'
            ...
            justifyContent: 'space-between'
              ...
              flexWrap: 'wrap'
                ...
                borderRadius: '1rem',
                padding: '.0rem .75rem'
              }} selectValue={"".concat((_m$id = m === null || m === void 0 ? void 0 : m.id) !== null && _m$id !== void 0 ? _m$id : '')} onClick={_event.selectThisText}>#{(_m$id2 = m === null || m === void 0 ? void 0 : m.id) !== null && _m$id2 !== void 0 ? _m$id2 : ''}</span>
                                        &nbsp;-&nbsp;
                                        <span selectValue={"".concat(m !== null && m !== void 0 && m.creation && !isNaN(Number(m.creation)) && new Date(Number(m.creation)) ? "".concat(new Date(Number(m.creation)).toDateString()) : '')} onClick={_event.selectThisText}>{m !== null && m !== void 0 && m.creation && !isNaN(Number(m.creation)) && new Date(Number(m.creation)) ? "".concat(new Date(Number(m.creation)).toDateString()) : ''}</span>
                                        {props.hideView ? null : <_react.default.Fragment>
                                                    &nbsp;-&nbsp;
                                                    <_link.default href={"".concat(props.devLocal ? "".concat(props.devAddress, "/r?o=").concat(m === null || m === void 0 ? void 0 : m.id) : "https://".concat(props.domainUrl, "/r?o=").concat(m === null || m === void 0 ? void 0 : m.id))} style={{
                  display: 'flex',
                  alignItems: 'center'
                }}>View 
                  ...
                  gap: '.5rem'
                    ...
                    width: '100%'
                                                                ...
                                                                <div className='flex gap-p2 Ecommerce_Cart_Title_Main_Container'>
                                                                    <div className='Ecommerce_Title'>{(_n$product$name = n === null || n === void 0 || (_n$product = n.product) === null || _n$product === void 0 ? void 0 : _n$product.name) !== null && _n$product$name !== void 0 ? _n$product$name : ''}</div>
                                                                    <div className={"Ecommerce_Cart_Price_Container ".concat(props !== null && props !== void 0 && props.expanded ? 'Ecommerce_Price_Expanded_Container' : null)}>
                                                                        <div className='Ecommerce_Price'>{symbol}{(0, _ecommerce.resolveMoneyFormat)(n.price)} {currency.toUpperCase()}</div>
                                                                    </div>
                                                                </div>
                                                                <div className='flex' style={{
                      justifyContent: 'space-between'
                          ...
                          color: 'grey'
                                                                            ...
                                                                            <div>{(_currentStyle$style = currentStyle === null || currentStyle === void 0 ? void 0 : currentStyle.style) !== null && _currentStyle$style !== void 0 ? _currentStyle$style : ''}</div>
                                                                            {_span || (_span = <span>&nbsp;~&nbsp;</span>)}
                                                                            <div>{(_currentOption$option = currentOption === null || currentOption === void 0 ? void 0 : currentOption.option) !== null && _currentOption$option !== void 0 ? _currentOption$option : ''}</div>
                                                                        </span>
                            ...
                            alignSelf: 'center'
                              ...
                              marginRight: '.25rem'
                                                                    ...
                                                                    <div className={"Ecommerce_Cart_Side_Meta_Container ".concat(props !== null && props !== void 0 && props.expanded ? 'Ecommerce_Price_Expanded_Container' : null)}>
                                                                        <div style={{
                          color: 'grey',
                          fontSize: '.7rem',
                          height: '17px',
                          textAlign: 'right'
                                                                        ...
                                                                        <div className='Ecommerce_Price'>{symbol}{(0, _ecommerce.resolveMoneyFormat)(n.quantity * n.price)} {currency.toUpperCase()}</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            justifyContent: 'space-between'
              ...
              lineHeight: '1.4rem'
                                    ...
                                    <div style={{
              fontSize: '1.25rem'
            }}>{useSymbol}{(_westernMoneyFormat$f = _ecommerce.westernMoneyFormat.format(m === null || m === void 0 || (_m$totals = m.totals) === null || _m$totals === void 0 ? void 0 : _m$totals.total)) !== null && _westernMoneyFormat$f !== void 0 ? _westernMoneyFormat$f : ''} {currency.toUpperCase()}</div>
                                </div>
                                <div>
                                    {m.paymentfulfilled ? <div>
                                                {m !== null && m !== void 0 && (_m$meta = m.meta) !== null && _m$meta !== void 0 && _m$meta.charged && m !== null && m !== void 0 && m.currency ? <div className={_ReceiptPageModule["default"].pair} style={{
                fontSize: '.7rem'
              }}>
                                                            <div>Paid {useSymbol}{(0, _ecommerce.resolveMoneyFormat)(m.amountcaptured)} {m.currency.toUpperCase()} on {new Date(m.meta.charged).toLocaleDateString()} {new Date(m.meta.charged).toTimeString()}</div>
                                                            <div>{card ? <div style={{
                    display: 'flex',
                    gap: '.25rem'
                  }}>
                                                                        <div>{(_card$brand = card.brand) !== null && _card$brand !== void 0 ? _card$brand : ''}</div>
                                                                        <div>{(_card$last = card.last4) !== null && _card$last !== void 0 ? _card$last : ''}</div>
                                                                        <div>{cardBilling !== null && cardBilling !== void 0 && cardBilling.name ? cardBilling.name : ''}</div>
                                                                    </div> : null}</div>
                                                        </div> : ''}
                                            </div> : <div>
                                                <div style={{
