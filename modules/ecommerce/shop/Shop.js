...
const Module = props => {
  ...
  return /*#__PURE__*/_jsx("div", {
  ...
  }, void 0, adminAuth && !noShop ? /*#__PURE__*/_jsx("div", {
    className: `${shopStyles.adminContainer}`
  }, void 0, _div || (_div = /*#__PURE__*/_jsx("div", {
    className: 'heading'
  }, void 0, "Shop")), /*#__PURE__*/_jsx("div", {
  ...
  }, void 0, "Create Product"), editing && !isObjectEmpty(editing) ? /*#__PURE__*/_jsx("button", {
    onClick: handleCancelProduct,
    modif: "save"
  }, void 0, editing.new ? 'Abandon' : 'Cancel') : null)) : null, /*#__PURE__*/_jsx("div", {
    className: `Product_flex_container`
  }, void 0, editing?.new ? /*#__PURE__*/_jsx("div", {
  ...
  }, void 0, <ProductImageManager {...props} editing={editing} passTempImages={passTempImages} />), /*#__PURE__*/_jsx("div", {
    ...
    fontWeight: '600',
    width: '100%'
  }} onChange={setCurrentName} ref={nameRef} modif='product_name' />), pageError.location && pageError.location === 'product_name' ? /*#__PURE__*/_jsx("div", {
    className: "error"
  }, void 0, pageError.message) : null), /*#__PURE__*/_jsx(Tooltip, {
    title: "Product Description",
    placement: "left"
  }, void 0, <TextareaAutosize className={`${PIMStyles.textArea}`} name='description' placeholder='Description' defaultValue={editing?.detailmeta?.description} onChange={handleUpdateProductDescription} ref={descriptionInputRef} />), /*#__PURE__*/_jsx("div", {
    className: "flex gap-p2",
    style: {
      alignItems: 'center'
    }
  ...
  }, void 0, currentDefinePriceCurrency?.symbol ?? '$')), <input type='currency' style={{
    width: '100%'
  }} defaultValue='10.00' ref={priceInput} onChange={setCurrentPrice} />, selectedStyle && currentDefinePriceCurrency?.currency === 'USD' && selectedStyle.price != priceInput?.current?.value || currentDefinePriceCurrency?.currency !== 'USD' && (!selectedStyle.priceTable || selectedStyle.priceTable && !selectedStyle.priceTable[currentDefinePriceCurrency.currency] || currentDefinePriceCurrency?.currency && selectedStyle.priceTable && Object.prototype.hasOwnProperty.call(selectedStyle.priceTable, currentDefinePriceCurrency.currency) && selectedStyle.priceTable[currentDefinePriceCurrency.currency] != priceInput.current.value) ? /*#__PURE__*/_jsx(Tooltip, {
    ...
    lineHeight: '.5rem'
  }} onClick={handleSetIsSettingCurrency} ref={currentCurrencyRef}>{currentDefinePriceCurrency?.currency ?? editing?.meta?.currency ?? 'USD'}</div>), isSettingCurrency ? /*#__PURE__*/_jsx("div", {
    className: `${PIMStyles.setCurrencyExternalContainer}`
  }, void 0, /*#__PURE__*/_jsx("div", {
    className: `${PIMStyles.setCurrencyContainer}`
  }, void 0, <select id={editing.id + '_setCurrency'} name={editing.id + '_setCurrency'} style={{
    width: '100%'
      ...
      value: m[1].currency,
      symbol: m[1].symbol
    }, void 0, /*#__PURE__*/_jsx("div", {}, void 0, m[1].currency), _div2 || (_div2 = /*#__PURE__*/_jsx("div", {}, void 0, "\xA0")), /*#__PURE__*/_jsx("div", {}, void 0, m[1].name), _div3 || (_div3 = /*#__PURE__*/_jsx("div", {}, void 0, "\xA0")), /*#__PURE__*/_jsx("div", {}, void 0, m[1].symbol))) : null}
    ...
    width: '100%',
    display: selectedOption && selectedOption.quantity && selectedOption.quantity === 10000000 ? 'none' : 'block'
  }} defaultValue='100' ref={quantityInput} onChange={setCurrentQuantity} />, _Tooltip || (_Tooltip = /*#__PURE__*/_jsx(Tooltip, {
  ...
  }, void 0, <input type="text" ref={styleInput} onChange={setCurrentStyleName} />, /*#__PURE__*/_jsx("select", {
  ...
  }, void 0, resolveStyles(editing).map((style, i) => {
    return /*#__PURE__*/_jsx("option", {
      value: style.sid,
      className: "style_option"
    }, i, style.style);
  }))))), selectedStyle && selectedStyle.option.length > 0 && selectedStyle.option[0] && Object.hasOwnProperty.call(selectedStyle.option[0], 'option') ? /*#__PURE__*/_jsx(Tooltip, {
    ...
    className: "dropdown_input"
  }, void 0, <input type="text" ref={optionInput} onChange={setCurrentOptionName} />, <select id={editing.id + '_options'} name={editing.id + '_options'} style={{
    width: '100%'
    ...
    option: "ticket"
  })), editingOptionsMeta.ticket ? /*#__PURE__*/_jsx("div", {}, void 0, /*#__PURE__*/_jsx(Tooltip, {
  ...
  })), editingOptionsMeta.eventDateDef.dates.length > 0 ? /*#__PURE__*/_jsx("div", {
    className: "tagContainer",
    style: {
      marginTop: '.25rem',
      marginBottom: '.25rem'
    }
  }, void 0, editingOptionsMeta.eventDateDef.dates.map((d, i) => {
    return d !== '' ? /*#__PURE__*/_jsx("div", {
      className: "tagItem"
    }, i, d ? getFormattedDate(d, {
      pretty: true
    }) : '') : _div4 || (_div4 = /*#__PURE__*/_jsx("div", {}));
  })) : _div5 || (_div5 = /*#__PURE__*/_jsx("div", {}))) : null), editingOptionsMeta && editingOptionsMeta.productType === 'virtual' ? /*#__PURE__*/_jsx("div", {}, void 0, /*#__PURE__*/_jsx("div", {
    className: "promptContainer",
    style: {
      borderRadius: '.5rem',
      margin: '.25rem 0'
    ...
    onChange: setOptionsMetaData,
    option: "livestream"
  })), editingOptionsMeta.livestream ? /*#__PURE__*/_jsx("div", {}, void 0, /*#__PURE__*/_jsx(Tooltip, {
  ...
  }, void 0, editingOptionsMeta.livestreamDef.dates.length > 0 ? /*#__PURE__*/_jsx("div", {
    className: "tagContainer",
    style: {
      marginTop: '.25rem'
    }
  }, void 0, editingOptionsMeta.livestreamDef.dates.map((d, i) => {
    return d !== '' ? /*#__PURE__*/_jsx("div", {
      className: "tagItem"
    }, i, d ? getFormattedDate(d, {
      pretty: true
    }) : '') : _div6 || (_div6 = /*#__PURE__*/_jsx("div", {}));
  })) : _div7 || (_div7 = /*#__PURE__*/_jsx("div", {})), editingOptionsMeta.livestreamDef.tags.length > 0 ? /*#__PURE__*/_jsx("div", {
    className: "tagContainer",
    style: {
      marginTop: '.25rem'
    }
  }, void 0, editingOptionsMeta.livestreamDef.tags.map((d, i) => {
    return d !== '' ? /*#__PURE__*/_jsx("div", {
      className: "tagItem"
    }, i, d) : _div8 || (_div8 = /*#__PURE__*/_jsx("div", {}));
  })) : _div9 || (_div9 = /*#__PURE__*/_jsx("div", {})))) : null, <Lineup {...props} product={editing} editing={editing} editingOptionsMeta={editingOptionsMeta} setOptionsMetaData={setOptionsMetaData} currentLineupEditing={currentLineupEditing} setCurrentLineupEditing={setCurrentLineupEditing} appendFormData={appendFormData} />)) : _div10 || (_div10 = /*#__PURE__*/_jsx("div", {})), /*#__PURE__*/_jsx("div", {
    ...
    onChange: setOptionsMetaData,
    option: "subscription"
  }))), !props?._loggedIn || !props?._loggedIn?.username ? /*#__PURE__*/_jsx("div", {}, void 0, <SignIn {...props} />, <Username {...props} />) : /*#__PURE__*/_jsx("div", {
    className: "flex gap-p2 Product_admin_choice_container",
    style: {
      marginTop: '.125rem'
    }
