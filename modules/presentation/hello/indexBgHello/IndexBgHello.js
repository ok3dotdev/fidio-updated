...
var Module = function Module(props) {
  ...
  return <div className={"".concat(_PresentationModule["default"].IndexBgContainer, " glide_").concat(componentId, " ").concat(props.className, " ").concat(props.medium ? "".concat(_PresentationModule["default"].IndexBgContainerMedium) : null)}>
            <div className={"".concat(_PresentationModule["default"].SliderBulletsContainer, " ").concat(moduleName, "_SliderBulletsContainer ").concat(props.sliderBulletsContainerClassName)}>
                <div className={"".concat(_PresentationModule["default"].SliderBullets, " glide__bullets")} data-glide-el="controls[nav]">
                    {props.items && props.items.map && props.items.length > 1 ? props.items.map(function (m, i) {
          return <button className={"".concat(_PresentationModule["default"].SliderBullet, " glide__bullet")} data-glide-dir={"=".concat(i)} key={i}></button>;
        }) : null}
                </div>
            </div>
      ...
      receiveData: receiveData
            ...
            <div className={"swipe slick-full slider_".concat(componentId)}>
        ...
        style: {
          ...
          return <div className={"".concat(_PresentationModule["default"].BgUpperContainer, " ").concat(moduleName, "_Container")} key={i}>
              ...
              backgroundImage: "url(".concat(resolveImage(m, (_m$leadBg = m === null || m === void 0 ? void 0 : m.leadBg) !== null && _m$leadBg !== void 0 ? _m$leadBg : null, 'bg'), ")")
                        ...
                        alignSelf: 'center'
                          ...
                          borderRadius: '4rem'
                                                        ...
                                                        <_link.default href={"/p?u=".concat((_m$author3 = m === null || m === void 0 ? void 0 : m.author) !== null && _m$author3 !== void 0 ? _m$author3 : '')} onClick={_utility2.handleSliderLinkClick} onMouseDown={_utility2.handleSliderLinkClickDown} onMouseUp={handleSliderLinkClickUpProxy} draggable={false} style={{
                      alignSelf: 'center'
                    }}>
                    ...
                    position: 'relative'
                      ...
                      fontSize: '.7rem'
                        ...
                        fontSize: '.7rem'
                                                    ...
                                                    {m !== null && m !== void 0 && (_m$item = m.item) !== null && _m$item !== void 0 && _m$item.id && m !== null && m !== void 0 && (_m$item2 = m.item) !== null && _m$item2 !== void 0 && _m$item2.style && m !== null && m !== void 0 && (_m$item3 = m.item) !== null && _m$item3 !== void 0 && _m$item3.option ? <div style={{
                    display: 'flex',
                    columnGap: '1rem',
                    rowGap: '.25rem',
                    flexWrap: 'wrap'
                  }}>
                                                                <button className={"".concat(_PresentationModule["default"].CtaButton, " ").concat(moduleName, "_Cta ").concat(props.ctaClassName)} onClick={handleFireGlobalEvent} action={['add_to_cart', 'buy'].indexOf(m === null || m === void 0 ? void 0 : m.action) > -1 ? m.action : 'add_to_cart'} item={m === null || m === void 0 || (_m$item4 = m.item) === null || _m$item4 === void 0 ? void 0 : _m$item4.id} selectedstyle={m === null || m === void 0 || (_m$item5 = m.item) === null || _m$item5 === void 0 ? void 0 : _m$item5.style} currentoption={m === null || m === void 0 || (_m$item6 = m.item) === null || _m$item6 === void 0 ? void 0 : _m$item6.option} ref={ctaRef} ctaAfter={m.ctaAfter} cta={m.cta}>{m.cta}</button>
                                                                {function (_m$styles, _m$item$useCustom, _m$item7) {
