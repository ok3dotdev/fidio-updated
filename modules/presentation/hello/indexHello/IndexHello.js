...
var Module = function Module(props) {
  ...
  return <div className={"".concat(_PresentationModule["default"].IndexHelloContainer, " sliderContainer_").concat(componentId, " ").concat(moduleName, "_IndexHelloContainer ").concat(props.className)} ref={sliderTrackRef}>
            {props.groupLabel ? <div className={"".concat(_PresentationModule["default"].GroupLabelContainer, " ").concat(moduleName, "_groupLabelContainer ").concat(props.groupLabelContainerClassName)}>
                        <div className={"".concat(_PresentationModule["default"].GroupLabel, " ").concat(moduleName, "_groupLabel ").concat(props.groupLabelClassName)}>{props.groupLabel}</div>
                    </div> : null}
            {useHandler && props !== null && props !== void 0 && (_props$request = props.request) !== null && _props$request !== void 0 && _props$request.handlerArgs ? <_fetch.FetchHandler {...Object.assign({
      handlerArgs: props.request.handlerArgs,
      receiveData: receiveData
    }, props)} /> : null}
            <div className={"swipe slider_".concat(componentId)}>
                <_reactSlick.default {...Object.assign({}, useSettings, {
        className: "".concat(_PresentationModule["default"].IndexItemsContainer, " swiper-wrapper slider_slides ").concat(moduleName, "_IndexItemsContainer slider_slides_").concat(componentId, " ").concat(props.IndexItemsContainerClassName)
          ...
          return <div className={"swiper-slide ".concat(_PresentationModule["default"].IndexItemUpperContainer, " ").concat(props.tall ? "".concat(_PresentationModule["default"].IndexItemsUpperContainerTall) : null, " ").concat(moduleName, "_Container ").concat(componentId, "_IndexItemUpperContainer ").concat(m.important ? "slider_item_important" : '')} key={i}>
                                            <_link.default href={(0, _utility2.resolveMainLink)(m)} onClick={_utility2.handleSliderLinkClick} onMouseDown={_utility2.handleSliderLinkClickDown} onMouseUp={handleSliderLinkClickUpProxy} draggable={false} style={{
              alignSelf: 'center'
            }}>
                                                <div className={"".concat(_PresentationModule["default"].BgContainer, " ").concat(props.tall ? "".concat(_PresentationModule["default"].BgContainerTall) : null, " ").concat(moduleName, "_BgContainer ").concat(props.bgClassName)} style={{
                ...
                position: 'relative'
                                                    ...
                                                    {props.children}
                                                    <div className={"".concat(_PresentationModule["default"].FillPageContainer, " ").concat(moduleName, "_FillPageContainer")}>
                                                        <div className={"".concat(_PresentationModule["default"].TimeContainer, " ").concat(moduleName, "_TimeContainer ").concat(props.timeContainerClassName)}>
                                                            {m !== null && m !== void 0 && m.showSimpleDate && useDate !== null && useDate !== void 0 && useDate.getMonth && useDate !== null && useDate !== void 0 && useDate.getDate ? <div className={"".concat(_PresentationModule["default"].TimeSimple, " ").concat(moduleName, "_TimeSimple ").concat(props.timeSimpleClassName, " ").concat((0, _utility2.datePassed)(m.date) ? "".concat(_PresentationModule["default"].DatePassed) : '')}>
                                                                        <div className={"".concat(_PresentationModule["default"].TimeShowContainer, " flex gap-p5")}>
                                                                            <div className={"".concat(_PresentationModule["default"].dateIconContainer)}>
                                                                                <div className={"".concat(_PresentationModule["default"].dateIconMonth)}>{(0, _date.retrieveMonth)(useDate.getMonth())}</div>
                                                                                <div className={"".concat(_PresentationModule["default"].dateIconDate)}>{useDate.getDate()}</div>
                                                                            </div>
                                                                            <div className={"".concat(_PresentationModule["default"].dateMetaContainer)}>
                                                                                <div className={"".concat(_PresentationModule["default"].dateText)}>{(0, _date.retrieveDay)(useDate.getDay())}, {useDate.toLocaleString('en-US', {
                              month: 'long'
                            })} {useDate.toLocaleDateString('en-US', {
                              day: '2-digit'
                            })}</div>
                                                                                <div className={"".concat(_PresentationModule["default"].timeMeta, " flex gap-p2")} style={{
                            alignContent: 'center'
                          }}>
                              ...
                              fontSize: '.7rem'
                                ...
                                fontSize: '.7rem'
                                                                                    ...
                                                                                    <div className={"".concat(_PresentationModule["default"].timeText)}>{useDate.toLocaleString('en-US', {
                                hour12: true,
                                hour: '2-digit',
                                minute: '2-digit'
                              })}</div>
                                                                                    {(m === null || m === void 0 || (_m$item = m.item) === null || _m$item === void 0 ? void 0 : _m$item.type) === 'ticket' ? <div className={"".concat(_PresentationModule["default"].ticketIcon)} style={{
                              height: '1rem'
                            }}><_iconsMaterial.ConfirmationNumber style={{
                                fontSize: '1rem',
                                height: '1rem'
                              }} /></div> : null}
                                                                                </div>
                                            ...
                                            <div>
                                                <div className={"".concat(_PresentationModule["default"].MetaContainer, " ").concat(moduleName, "_MetaContainer ").concat(props.metaContainerClassName)}>
                                                    {(m === null || m === void 0 ? void 0 : m.icon) !== '' ? <div className={"".concat(_PresentationModule["default"].IconContainer, " ").concat(moduleName, "_IconContainer ").concat(props.iconContainerClassName)}>
                                                                <_link.default href={"/p?u=".concat((_m$author = m === null || m === void 0 ? void 0 : m.author) !== null && _m$author !== void 0 ? _m$author : '')} onClick={_utility2.handleSliderLinkClick} onMouseDown={_utility2.handleSliderLinkClickDown} onMouseUp={handleSliderLinkClickUpProxy} draggable={false} style={{
                    alignSelf: 'center'
                  }}>
                      ...
                      borderRadius: '4rem',
                      minHeight: '50px'
                    }} alt={(_m$author2 = m === null || m === void 0 ? void 0 : m.author) !== null && _m$author2 !== void 0 ? _m$author2 : ''} width={(_m$iconWidth = m === null || m === void 0 ? void 0 : m.iconWidth) !== null && _m$iconWidth !== void 0 ? _m$iconWidth : '50'} height={(_m$iconHeight = m === null || m === void 0 ? void 0 : m.iconHeight) !== null && _m$iconHeight !== void 0 ? _m$iconHeight : '50'} layout="responsive" />
                                                                </_link.default>
                                                            </div> : null}
                    ...
                    alignSelf: 'center'
                                                        ...
                                                        <div className={"".concat(_PresentationModule["default"].CtaHolder, " ").concat(moduleName, "_CtaHolder ").concat(props.CtaHolderClassName)}>
                                                            <_link.default href={"/p?u=".concat(m === null || m === void 0 ? void 0 : m.author)} onClick={_utility2.handleSliderLinkClick} onMouseDown={_utility2.handleSliderLinkClickDown} onMouseUp={handleSliderLinkClickUpProxy} draggable={false} style={{
                      alignSelf: 'center'
                    }}>
                                                                <div className={"".concat(_PresentationModule["default"].Author, " ").concat(moduleName, "_Author ").concat(props.authorClassName)}>{(_m$author3 = m === null || m === void 0 ? void 0 : m.author) !== null && _m$author3 !== void 0 ? _m$author3 : ''}</div>
                                                            </_link.default>
                                                            {/* {
                                                            ...
                                                            {m !== null && m !== void 0 && (_m$item2 = m.item) !== null && _m$item2 !== void 0 && _m$item2.id && m !== null && m !== void 0 && (_m$item3 = m.item) !== null && _m$item3 !== void 0 && _m$item3.style && m !== null && m !== void 0 && (_m$item4 = m.item) !== null && _m$item4 !== void 0 && _m$item4.option ? <button className={"".concat(_PresentationModule["default"].CtaButton, " ").concat(moduleName, "_Cta ").concat(props.ctaClassName)} onClick={handleFireGlobalEvent} action={['add_to_cart', 'buy'].indexOf(m === null || m === void 0 ? void 0 : m.action) > -1 ? m.action : 'add_to_cart'} item={m === null || m === void 0 || (_m$item5 = m.item) === null || _m$item5 === void 0 ? void 0 : _m$item5.id} selectedstyle={m === null || m === void 0 || (_m$item6 = m.item) === null || _m$item6 === void 0 ? void 0 : _m$item6.style} currentoption={m === null || m === void 0 || (_m$item7 = m.item) === null || _m$item7 === void 0 ? void 0 : _m$item7.option} ref={ctaRef} ctaAfter={m.ctaAfter} cta={m.cta}>{m.cta}</button> : null}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
