...
var Module = function Module(props) {
  ...
  var _React$useState = _react["default"].useState(false),
    ...
    didCheckAdminAuth = _React$useState2[0],
    setDidCheckAdminAuth = _React$useState2[1];
  ...
  var _React$useState5 = _react["default"].useState(false),
    ...
    googleSignInRendered = _React$useState6[0],
    googleSignInRenderedSet = _React$useState6[1];
  var _React$useState7 = _react["default"].useState(false),
    _React$useState8 = _slicedToArray(_React$useState7, 2),
    hideGoogleSignIn = _React$useState8[0],
    setHideGoogleSignIn = _React$useState8[1];
  var _React$useState9 = _react["default"].useState(null),
    _React$useState10 = _slicedToArray(_React$useState9, 2),
    pageError = _React$useState10[0],
    setPageError = _React$useState10[1];
