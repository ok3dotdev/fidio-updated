...
var Module = function Module(props) {
  ...
  var _React$useState = _react["default"].useState(false),
    ...
    registerUsernameOn = _React$useState2[0],
    setRegisterUsernameOn = _React$useState2[1];
  var _React$useState3 = _react["default"].useState(false),
    _React$useState4 = _slicedToArray(_React$useState3, 2),
    googleSignInRendered = _React$useState4[0],
    googleSignInRenderedSet = _React$useState4[1];
  var _React$useState5 = _react["default"].useState(false),
    _React$useState6 = _slicedToArray(_React$useState5, 2),
    hideGoogleSignIn = _React$useState6[0],
    setHideGoogleSignIn = _React$useState6[1];
  var _React$useState7 = _react["default"].useState(null),
    _React$useState8 = _slicedToArray(_React$useState7, 2),
    pageError = _React$useState8[0],
    setPageError = _React$useState8[1];
