...
var Module = function Module(props) {
  ...
  return <_react.default.Fragment>
            {props._adminAuth && (props === null || props === void 0 || (_props$profileData = props.profileData) === null || _props$profileData === void 0 || (_props$profileData = _props$profileData.user) === null || _props$profileData === void 0 ? void 0 : _props$profileData.id) === (props === null || props === void 0 || (_props$_loggedIn = props._loggedIn) === null || _props$_loggedIn === void 0 ? void 0 : _props$_loggedIn.identifier) && !props._currentlyStreaming ? <div className={"".concat((_props$className = props === null || props === void 0 ? void 0 : props.className) !== null && _props$className !== void 0 ? _props$className : '')}>
                        <button className={"".concat(props === null || props === void 0 || (_props$ManagerStyles = props.ManagerStyles) === null || _props$ManagerStyles === void 0 ? void 0 : _props$ManagerStyles.streamingButton, " ").concat(props === null || props === void 0 || (_props$ManagerStyles2 = props.ManagerStyles) === null || _props$ManagerStyles2 === void 0 ? void 0 : _props$ManagerStyles2.streamingButtonMini, " ").concat(props._managerOpen ? "".concat(props === null || props === void 0 || (_props$ManagerStyles3 = props.ManagerStyles) === null || _props$ManagerStyles3 === void 0 ? void 0 : _props$ManagerStyles3.streamingButtonOff) : '')} onClick={handleOpenBeginStream}>Begin Stream</button>
                    </div> : null}
