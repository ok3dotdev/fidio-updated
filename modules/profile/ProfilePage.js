...
var Module = function Module(props) {
  var _React$useState = _react["default"].useState({}),
    ...
    currentLive = _React$useState2[0],
    setCurrentLive = _React$useState2[1];
  var _React$useState3 = _react["default"].useState([]),
    _React$useState4 = _slicedToArray(_React$useState3, 2),
    feed = _React$useState4[0],
    setFeed = _React$useState4[1];
  var _React$useState5 = _react["default"].useState([]),
    _React$useState6 = _slicedToArray(_React$useState5, 2),
    combinedFeed = _React$useState6[0],
    setCombinedFeed = _React$useState6[1];
  var _React$useState7 = _react["default"].useState(false),
    _React$useState8 = _slicedToArray(_React$useState7, 2),
    adminPanelState = _React$useState8[0],
    setAdminPanelState = _React$useState8[1];
