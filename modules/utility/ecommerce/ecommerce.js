...
var calculateTotal = function calculateTotal(cart, prefix, options, props) {
  var prices = [];
  var total = 0;
  if (cart && cart.items) {
...
var resolveRegionBasedPrice = function resolveRegionBasedPrice(props, style) {
  var _props$_loggedIn, _props$_loggedIn$loca;
  console.log(props, style);
  if (props !== null && props !== void 0 && (_props$_loggedIn = props._loggedIn) !== null && _props$_loggedIn !== void 0 && (_props$_loggedIn$loca = _props$_loggedIn.locationMeta) !== null && _props$_loggedIn$loca !== void 0 && _props$_loggedIn$loca.country && props !== null && props !== void 0 && props.regionsData) {
    var location = props._loggedIn.locationMeta.country;
...
exports.resolveRegionBasedPrice = resolveRegionBasedPrice;