...
const BulletCard = ({ feature, description }) => {
  return (
    <Card className='dark:bg-transparent dark:border-none shadow-none flex items-center font-lexend max-w-[770px] mx-auto px-4'>
