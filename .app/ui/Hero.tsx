...
const Hero = () => {
  ...
  return (
    <div className='h-screen w-full relative'>
      ...
      <div className='absolute top-0 right-0 left-0 w-full max-w-[108rem] mx-auto p-4 px-4 text-center lg:text-left lg:flex 2xl:pt-[157px] pt-[40px] lg:pt-[140px] flex flex-col lg:flex-row gap-1 h-full z-20 overflow-hidden justify-center'>
        <div className='flex flex-col lg:flex-row'>
          <div className='flex flex-col items-start gap-4 justify-start lg:justify-start flex-wrap left-container'>
            <h2 className='font-black text-[26px] md:text-6xl lg:text-[67px] 2xl:text-[84px]  mb-1 text-white text-left leading-[44px] flex-col mr-4'>
              Find joy through live Afro{' '}
            </h2>
            <div className='hidden lg:flex items-center gap-4'>
              <p className='font-sans text-white'>Ready to stream? </p>
              {props._loggedIn ? (
                <Link
                  href='/home'
          ...
          <div className='flex items-center gap-4 mt-4 justify-start lg:justify-start flex-wrap lg:mt-8 lg:hidden'>
            <p className='font-sans text-white'>Ready to stream? </p>
            {props._loggedIn ? (
              <Link
                href='/home'
