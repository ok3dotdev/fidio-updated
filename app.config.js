...
const resolveVariables = () => {
  ...
  //   dev: true,
  //   googleClientId:
  //     '169701902623-9a74mqcbqr38uj87qm8tm3190cicaa7m.apps.googleusercontent.com',
  //   // devLocal: true,
  //   devAddress: 'http://localhost:3020',
  //   domainKey: 'A8J29AAJSD8239D0930FJSDJFISJOFRJ2098DJ2',
  //   domainUrl: 'development.fidio.ca',
  ...
  //     forceShowCc: true,
  //     keys: {
  //       paystack: 'paystack key here!',
  //       stripe:
  //         'pk_test_51NspsBF8sWqWDDvYwSbVtUXwsDST0xd6Sbn0ZX5BsKltOz6S1CEq5QiA8ZoWDFRpIRk3n9L012W7AzfHdlKOOmFr00eXQ0WiKu',
  //     },
  //     tax: {
  //       all: 0.13,
  //     },q
  ...
  // };
  return {
    apiUrl: 'https://dbservices.tycoon.systems/api', // local: 'http://127.0.0.1:5330/' dev: https://dbservices.tycoon.systems/apidev/
    corsdefault: 'include',
    dborigin: 'fidio',
    domainKey: 'A8J29AAJSD8239D0930FJSDJFISJOFRJ2098DJ2',
    ...
    googleClientId:
      '169701902623-9a74mqcbqr38uj87qm8tm3190cicaa7m.apps.googleusercontent.com',
    menuConfig: predefined.MenuConfig,
    chatConfig: predefined.ChatConfig,
    paymentConfig: predefined.PaymentConfig,
    helpIndex: predefined.HelpIndex,
    settingsConfig: predefined.SettingsConfig,
    feedbackConfig: predefined.FeedbackConfig,
...
export { resolveVariables, pageDefaults };
