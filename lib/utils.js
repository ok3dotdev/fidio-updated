...
export const fetchVideosForUser = async (author, limit, offset) => {
  return await apiReq('/fetch/fetchhandler', {
    handlerArgs: [
        {
...
export const groupByDate = (tickets) => {
  return tickets?.reduce((groups, event) => {
    const dateString = event?.meta?.date || event.created; // e.g., "Mon May 27 2024 12:55:04 GMT-0400 (Eastern Daylight Time)"
